...
<div class="rpt-footer">Generated by ACOS Accounting · ${COMPANY_NAME} · ${new Date().toLocaleString()}</div>
</body></html>`)
  w.document.close()
}
...
export function printTableReport(
  ...
  printHtml(reportTitle, `
    <div class="rpt-header">
      <div><div class="rpt-company">${COMPANY_NAME}</div><div class="rpt-sub">Accounting Software</div></div>
